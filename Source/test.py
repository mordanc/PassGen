...
def gui_main():
    ...
    has_numbers_checkbutton.pack(anchor=W)
    ...
    has_lowercase_checkbutton.pack(anchor=W)
    ...
    has_uppercase_checkbutton.pack(anchor=W)

    # get the length of the password
    length_label = ttk.Label(frames["main_frame"], text="Enter password length:")
    length_label.pack(side=TOP, anchor=W)
